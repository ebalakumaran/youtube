...
def create_winners_video(duration, text_clip, screen_size,filename,number,viewCount):
    ...
    final.subclip(0,duration).write_videofile("C:\\Users\\User\\PycharmProjects\\youtube-main\\complete video creation\\mergingFolder\\"+str(number+2)+".mp4",threads=16,fps=30,codec='libx264')
...
if __name__ == "__main__":
    ...
    folder_path = "C:\\Users\\User\\PycharmProjects\\youtube-main\\complete video creation\\mergingFolder"
    allowed_names = ["1.mp4", "2.mp4", "6.mp4"]
    ...
    selected_files = [filename for filename in files if filename.startswith(('1 ', '2 ', '3 '))]
    videos_full_names=[]
    videos_views_count=[]
